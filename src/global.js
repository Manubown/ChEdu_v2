...
class Global extends React.Component {
  ...
  getCarlsen_vs_Kramnik = () => {
    return this.pgn.Carlsen.Carlsen_vs_Kramnik;
  };

  getCarlsen_vs_Aronian = () => {
    return this.pgn.Carlsen.Carlsen_vs_Aronian;
  };

  getCarlsen_vs_Nakamura = () => {
    return this.pgn.Carlsen.Carlsen_vs_Nakamura;
  };

  getCarlsen_vs_Gelfand = () => {
    return this.pgn.Carlsen.Carlsen_vs_Gelfand;
  };

  getCarlsen_vs_Kasparov = () => {
    return this.pgn.Carlsen.Carlsen_vs_Kasparov;
  };
  //#endregion

  //#region Nakamura
  getNakamura_vs_Gelfand = () => {
    return this.pgn.Nakamura.Nakamura_vs_Gelfand;
  };
  getNakamura_vs_Stripunsky = () => {
    return this.pgn.Nakamura.Nakamura_vs_Stripunsky;
  };
  getNakamura_vs_Oluto_Adu = () => {
    return this.pgn.Nakamura.Nakamura_vs_Oluto_Adu;
  };
  getNakamura_vs_Novikov = () => {
    return this.pgn.Nakamura.Nakamura_vs_Novikov;
  };
  get = () => {
    return this.pgn.Nakamura.Nakamura_vs_Crafty_AI;
  };

  //#endregion

  //#region Kasparov
  getKasparov_vs_Magerramov = () => {
    return this.pgn.Kasparov.Kasparov_vs_Magerramov;
  };
  getKasparov_vs_Palatnik = () => {
    return this.pgn.Kasparov.Kasparov_vs_Palatnik;
  };
  getKasparov_vs_Topalov = () => {
    return this.pgn.Kasparov.Kasparov_vs_Topalov;
  };
  getKasparov_vs_Karpov = () => {
    return this.pgn.Kasparov.Kasparov_vs_Karpov;
  };
  getKasparov_vs_Anand = () => {
    return this.pgn.Kasparov.Kasparov_vs_Anand;
  };
  getKasparov_vs_Deep_Blue = () => {
    return this.pgn.Kasparov.Kasparov_vs_Deep_Blue;
  };
  getKasparov_vs_Karpov_Second = () => {
    return this.pgn.Kasparov.Kasparov_vs_Karpov_Second;
  };
  //#endregion
